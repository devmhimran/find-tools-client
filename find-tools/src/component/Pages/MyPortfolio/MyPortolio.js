        ...
        <div className="hero py-14 lg:py-24 my-10 bg-slate-200 rounded-lg">
          <div className="hero-content flex-col lg:flex-row">
            <img
              ...
              className="w-7/12 lg:w-80 rounded-lg"
            />
            <div className="ml-5">
              <h1 className="text-5xl font-bold">Bsc. in CSE</h1>
              <p className="py-6">
                I've successfully complete Bsc. in CSE from Bangladesh
                University of Business and Technology (BUBT). Since 2018-2022
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="card shadow-2xl ">
              <div className="card-body">
                ...
                <a
                  ...
                  href="https://grocery-shop-4df4d.web.app/"
                >
                  visit
                </a>
              </div>
          ...
          <div className="project__card">
            <div className="card shadow-2xl ">
              <div className="card-body">
                ...
                <a
                  className="btn btn-primary"
                  href="https://wedding-ultra-shots.web.app/"
                >
                  visit
                </a>
              </div>
          ...
          <div className="project__card">
            <div className="card shadow-2xl ">
              <div className="card-body">
                ...
                <a
                  className="btn btn-primary"
                  href="https://hero-headphone.netlify.app/"
                >
                  {" "}
                  visit
                </a>
